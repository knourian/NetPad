    ...
    HashSet<string>? assemblyFileReferences = null)
{
    ...
    public HashSet<byte[]> AssemblyImageReferences { get; } = assemblyImageReferences ?? new HashSet<byte[]>();
    public HashSet<string> AssemblyFileReferences { get; } = assemblyFileReferences ?? new HashSet<string>();
